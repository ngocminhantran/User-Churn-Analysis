...
### Insights
#### Overview
The current churn rate (~27%) is higher than the average churn rate (21%) in Telecom industry (according to Statista, 2020, assuming the company is based in the US). This group contributed up to about $1,368,000 (about 16%) to the company’s revenue. The company, therefore, needs to take action on this problem as soon as possible.
#### Churner profile
